...
function FsGlobe() {
    ...
    s.enableDamping = !0, s.enablePan = !1, s.minDistance = 1.2, s.maxDistance = 4, s.autoRotate = !0, s.autoRotateSpeed = .2, s.enableZoom = !1, s.update();
    ...
    //Globe creation - standard
    const E = new THREE.SphereBufferGeometry(1, 64, 32),

    //GLobe creation - loading custom model
